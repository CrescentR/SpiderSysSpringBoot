...
public enum ResultCodeEnum {
    ...
    ADMIN_CODE_ERROR(302, "验证码错误"),
    ADMIN_CAPTCHA_CODE_ERROR(303, "图形验证码错误！"),
    ADMIN_CAPTCHA_CODE_NOT_FOUND(304, "未输入验证码"),
    PHONE_FORMAT_ERROR(307, "手机号格式错误"),

    ADMIN_LOGIN_AUTH(305, "未登陆"),
    ADMIN_ACCOUNT_NOT_EXIST_ERROR(306, "账号不存在"),
    ADMIN_PASSWORD_ERROR(307, "用户名或密码错误"),
    ADMIN_ACCOUNT_DISABLED_ERROR(308, "该用户已被禁用"),
    ADMIN_ACCESS_FORBIDDEN(309, "无访问权限"),
    ADMIN_CURRENT_PASSWORD_ERROR(310, "旧密码错误"),
    ADMIN_NOT_NULL_PASSWORD(311, "新密码不能与旧密码相同"),
